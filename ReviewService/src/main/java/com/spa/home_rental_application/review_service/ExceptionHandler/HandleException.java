package com.spa.home_rental_application.review_service.ExceptionHandler;

import com.spa.home_rental_application.review_service.Exceptionclass.DTO.APIErrorResponse;
...
public class HandleException {
    ...
    public ResponseEntity<APIErrorResponse> handleNotFound(ReviewNotFoundException ex, HttpServletRequest req) {
        log.warn("Review not found at {}: {}", req.getRequestURI(), ex.getMessage());
        return build(HttpStatus.NOT_FOUND, ex.getMessage(), ex.getErrorCode(), req);
    }

    @ExceptionHandler(InvalidReviewException.class)
    public ResponseEntity<APIErrorResponse> handleInvalid(InvalidReviewException ex, HttpServletRequest req) {
    ...
    public ResponseEntity<APIErrorResponse> handleMalformedJson(HttpMessageNotReadableException ex, HttpServletRequest req) {
        return build(HttpStatus.BAD_REQUEST,
                "Malformed JSON payload: " + rootCauseMessage(ex), "MALFORMED_JSON", req);
    }
