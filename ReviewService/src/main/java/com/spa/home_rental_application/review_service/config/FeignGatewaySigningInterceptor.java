 ...
 * property-service / payment-service / lease-service. Without this,
 * ReviewService's Feign calls to property-service (used to look up a
 * building's ownerId so reviews route to the right owner) get
 * rejected by the downstream {@code GatewayAuthFilter} with
