...
/**
 * springdoc-openapi metadata for the Maintenance Service.
    ...
    public OpenAPI maintenanceServiceOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("Tenant maintenance request workflow: lifecycle, assignment, comments, " +
                                "status transitions, image uploads, and analytics. Consumes flat.vacated " +
                                "from Property Service to auto-close pending requests.")
                        .version("v1")
