...
/**
 * Global exception translator producing a uniform {@link APIErrorResponse} envelope.
 *
 * <p>Coverage:
 * <ul>
 *   <li>Domain — RecordNotFound, DuplicateUser, InvalidDocumentType</li>
 *   <li>Validation — body & query/path</li>
 *   <li>Request shape — malformed JSON, missing/typed params, wrong method, unknown route</li>
 *   <li>Persistence — DataIntegrityViolation</li>
 *   <li>Uploads — Max size, multipart</li>
 *   <li>Service-to-service — FeignException</li>
 *   <li>Optional usage — NoSuchElement</li>
 *   <li>I/O — generic IOException</li>
 *   <li>Catch-all</li>
 * </ul>
 */
...
public class HandleException {
    ...
    public ResponseEntity<APIErrorResponse> handleRecordNotFound(RecordNotFound ex, HttpServletRequest req) {
    ...
    public ResponseEntity<APIErrorResponse> handleInvalidDocType(InvalidDocumentTypeException ex, HttpServletRequest req) {
    ...
    public ResponseEntity<APIErrorResponse> handleDataIntegrity(DataIntegrityViolationException ex, HttpServletRequest req) {
        ...
        return build(HttpStatus.CONFLICT,
                "Database constraint violated (likely duplicate value): " + rootCauseMessage(ex),
    ...
    public ResponseEntity<APIErrorResponse> handleFeign(FeignException ex, HttpServletRequest req) {
        log.warn("Downstream service error at {}: status={} body={}",
