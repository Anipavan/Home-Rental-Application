package com.spa.home_rental_application.analytics_service.analytics_service.exception;

import com.spa.home_rental_application.analytics_service.analytics_service.exception.DTO.APIErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<APIErrorResponse> handleIo(IOException ex, HttpServletRequest req) {
        ...
        return build(HttpStatus.INTERNAL_SERVER_ERROR,
                "An I/O error occurred while generating the report", "IO_ERROR", req);
    }
