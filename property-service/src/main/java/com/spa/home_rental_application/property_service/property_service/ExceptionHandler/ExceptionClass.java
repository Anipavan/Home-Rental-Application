...
public class ExceptionClass {
    ...
    public ResponseEntity<APIErrorResponse> handleBuildingHasFlatsException(BuildingHasFlatsException ex){
    ...
    public ResponseEntity<APIErrorResponse> handleFlatOccupiedExceptionn(FlatOccupiedException ex){
    ...
    public ResponseEntity<APIErrorResponse> handleInvalidLeasePeriodException(InvalidLeasePeriodException ex){
